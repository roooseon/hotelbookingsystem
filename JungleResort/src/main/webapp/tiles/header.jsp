		...
		<nav class="navbar navbar-inverse navbar-static-top">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="/"><spring:message code="JungleSideResort" /></a>
				</div>
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							aria-expanded="false"><spring:message code="Rooms" /> <span class="caret"></span></a>
						...
						<li><a href="/availableroomslist"><spring:message code="AvailableRooms" /></a></li>
						<li><a href="#contact"><spring:message code="ContactUs" /></a></li>
						<li class="dropdown"><c:choose>
								<c:when test="${empty user}">
									<a href='/customerlogin' role="button"><spring:message code="Signin" /></a>
								</c:when>
								<c:otherwise>
